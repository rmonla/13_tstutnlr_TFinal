 ...
 -->					</li>
					...
					<li id="#Consultas"  class="active">
						...
						<ul>
							...
							<li>
								<a href="cons_hist.php">Histórico</a>
							</li>
							<li>
		...
		<div class="wrapper col4">
			<div id="container"><!-- ###### <contenido> ###### -->
				<div id="content">
			      ...
			      <div id="respond">
              			<form name="rev" method="post" action="rep_hist.php"/>
							...
							<table width="80%">
								<tr>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Escuela</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Antiguedad</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Horas</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Cargo</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Dias</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Area</strong></div></td>
								  <td nowrap="nowrap" class="col1"><div align="center"><strong>Sit. Revista</strong></div></td>
									<td nowrap="nowrap" class="col1"><div align="center"><strong>Periodo</strong></div></td>
								...
								<tr>
						          ...
						          <?php echo $situacion['sit'][$i]['escuela'];?></div></td>
									...
									<td nowrap="nowrap" class="col1">
								      <div align="center">
								        <input type="hidden" name="rev" size="30" value="<?php echo $situacion['sit'][$i]['periodo'];?>"><?php echo $situacion['sit'][$i]['periodo'];?></td>
							  <tr>
										<td colspan="8">
