		...
		<div class="wrapper col3">
		  <div class="col1" id="breadcrumb"><!-- ###### <Ud está aquí> ###### -->
		  		<table width="80%" border="1" cellpadding="20" class="col2">
  					<tr>
   					  <td height="30" colspan="2" class="bold Estilo1"><div align="center" class="Estilo3">Eliminar  de Usuarios </div></td>
					    <td width="30%"><div align="center" class="Estilo2"></div></td>
  					</tr>
  					<form name="alta" action="del_usr2.php" method="post">
					<tr>
				  ...
				  <tr>
  					  ...
  					  <td align="center" valign="middle" class="Estilo3">
					  <div align="left">
					  	<input name="dire" type="text" class="Estilo3" size="60" value="<?php echo $reg['docu'];?>"/>
					  </div></td>
  					  <td valign="top"></td>
				  </tr>
				  </tr>
  					...
  					<tr>
  					  <td width="27%" align="center" valign="middle" class="Estilo3">
					  	<div align="center"><a href="usuarios.php"></a> </div></td>
					  </td>
					  <td valign="top"> 
					    <div align="right">
					      <input name="enviar" type="submit" class="Estilo3" value="ELIMINAR" />
			            </div>
						</td>
				  	</tr>
				</form>
