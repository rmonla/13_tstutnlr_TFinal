...
<div align="center">
  <div align="center">
    <div align="center">
      ...
      <TABLE border=0 cellPadding=0 cellSpacing=0 width="91%">
        <TR>
          <TD width="65%" height=47><DIV align=center class=CompanyName>
            <div align="left"><strong>Exportar Codigos </strong></div>
          </DIV></TD>
	  ...
	  <table width="75%" border="5" align="center" cellpadding="" bordercolor="#000099">
	  <form name="form1">
		<tr>
			...
			?>
              ...
              <? 
					while($fila = (mysql_fetch_array($resultado)))
						{?>
              <option value="<? echo $fila['id'];?>"><? echo $fila['docu'];?></option>
              <? }?>
            </select>
  		  </strong></div>		  </td>
		...
		<tr>
			...
			<td colspan="11" bgcolor="#FFFFFF"><div align="left"><input name="obs" type="text" size="130"/></div></td>
		</tr>
		</form>
		<tr>
			<td width="6%" height="30" colspan="13" bgcolor="#CCCCCC"><div align="center" class="CompanyName">
				<button type="submit" onClick="header("location:export2.php")">CARGAR</button>
			</div></td>
		</tr>
		</table>
		<br>
		...
		<td width="6%" bgcolor="#FFFFFF"><div align="center"><strong>
		  ...
		  <select name="area">
            ...
            <? 
					...
					if(mysql_query($sql,$conexion_mysql))
						$res_cod = (mysql_query($sql,$conexion_mysql));
					while($fila_a= (mysql_fetch_array($res_cod)))
						{?>
            <option value="<? $fila_a['id'];?>"><? echo $fila_a['area'];?></option>
            <? }*/?>
          </select>
		  </div>
          </strong></div>		  </td>
