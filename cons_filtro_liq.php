 ...
 -->					</li>
		...
		<div class="wrapper col4">
			<div id="container"><!-- ###### <contenido> ###### -->
				<div id="content">
		      	<h2>CONSULTAS POR FILTROS </h2>
			      <div id="respond">
						<form action="filtros_liq.php" method="post" enctype="multipart/form-data">
							<table width="50%">
								<tr>
									<select name="filtro">
										...
										<option value="4">->Cargos (Nomenclador)</option>
										<option value="5">->Planes</option>
										<option value="6">->Codigos</option>
										<option value="7">->Periodo</option>
					        		</select>
								</tr>
								<tr>
										<input type="submit" class="bold" value="Consultar" />
								</tr>
