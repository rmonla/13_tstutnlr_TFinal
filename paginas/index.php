...
<TABLE border=0 cellPadding=0 cellSpacing=0 width="75%">
  <TR>
    <TD height=50><DIV align=center class=CompanyName>
      <div align="center" class="Estilo4">Login - EduLiq </div>
    </DIV></TD>
  </TR>
  <TR>
    <TD colSpan=2>
  ...
  <TR>
    <TD colSpan=2 height=12>
      <DIV align=center class="Estilo5"><? echo $msj;?></DIV>	</TD>
  </TR>
  <TR>
    <TD colSpan=2>
      <DIV align=left>
...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="75%">
  <TR>
    <TD width=316 height=393 align="center" vAlign=middle><BR>
    <img src="image/login_img.gif" width="332" height="352"></TD>
    <TD height=393 vAlign=top width="354"><BR>
      <BR><BR>
      <BR>
	  <BR>
	  <BR>
	   ...
	   <TABLE width="101%" height="173" border=0 cellPadding=0 cellSpacing=0 bgColor=#ffffff>
		...
		<tr bgcolor="#F0F0F0">
		  <th colspan="2" bgcolor="#ffcc00" bordercolor="3"><div align="center">
		  	<form name="session" method="post" action="validar1.php"/></div>			</th>
		</tr>
		<tr>
			<th bordercolor="3" bgcolor="#66AADD"><div align="right"><span class="Estilo1">USUARRIO:</span> </div></th>
			<td width="50%" bordercolor="3" bgcolor="#FFFF66"><input name="usuario" type="text" size="30"/></td>
		</tr>
		<tr>
		...
		<tr>
		  <th bordercolor="3" bgcolor="#66AADD"><div align="right"><span class="Estilo1">PASSWORD:</span> </div></th>
			<td width="50%" bordercolor="3" bgcolor="#FFFF66"><input name="pass" type="password" size="30"/></td>
		</tr>
		<tr bgcolor="#F0F0F0">
		 ...
		 <tr bgcolor="#F0F0F0">
		  <th colspan="2" bgcolor="#ffcc00" bordercolor="3"><div align="center">
		      ...
		      <label>
		        <input name="Submit" type="submit" class="Estilo5" value="LOGUEARSE">
	          </label>
		      </form>
		    </div></th>
		 </tr>
  ...
  <TR vAlign=top>
    <TD colSpan=4>
      ...
      <DIV align=center>
		<FONT color=#3169a5 face="Arial, Helvetica, sans-serif" size=2><strong>Copyright 2013. Gaston Francisco Cipolatti. Todos los Derechos Reservados</strong>.</FONT>	  </DIV>
      <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
        <TR bgColor=#006500>
